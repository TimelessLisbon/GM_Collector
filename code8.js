...
gdjs.Eq_46_32AzulClaraCode.GDResumoObjects1= [];
gdjs.Eq_46_32AzulClaraCode.GDResumoObjects2= [];
...
gdjs.Eq_46_32AzulClaraCode.asyncCallback20751612 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.Eq_46_32AzulClaraCode.asyncCallback20751612(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Eq_46_32AzulClaraCode.eventsList1 = function(runtimeScene) {
...
gdjs.copyArray(runtimeScene.getObjects("Resumo"), gdjs.Eq_46_32AzulClaraCode.GDResumoObjects1);
gdjs.copyArray(runtimeScene.getObjects("Team_Name"), gdjs.Eq_46_32AzulClaraCode.GDTeam_9595NameObjects1);
{for(var i = 0, len = gdjs.Eq_46_32AzulClaraCode.GDResumoObjects1.length ;i < len;++i) {
    gdjs.Eq_46_32AzulClaraCode.GDResumoObjects1[i].getBehavior("Text").setText("Local: " + runtimeScene.getScene().getVariables().getFromIndex(0).getAsString() + " Score: " + runtimeScene.getScene().getVariables().getFromIndex(1).getAsString() + " Rsp: " + runtimeScene.getScene().getVariables().getFromIndex(2).getAsString() + " Erros:" + runtimeScene.getScene().getVariables().getFromIndex(3).getAsString());
}
...
{gdjs.evtTools.firebaseTools.database.updateField(runtimeScene.getGame().getVariables().getFromIndex(6).getAsString(), "ClueGM", (( gdjs.Eq_46_32AzulClaraCode.GDPistaGMObjects1.length === 0 ) ? "" :gdjs.Eq_46_32AzulClaraCode.GDPistaGMObjects1[0].getBehavior("Text").getText()), runtimeScene.getScene().getVariables().getFromIndex(7));
}}
...
gdjs.copyArray(runtimeScene.getObjects("Team_Name"), gdjs.Eq_46_32AzulClaraCode.GDTeam_9595NameObjects1);
{for(var i = 0, len = gdjs.Eq_46_32AzulClaraCode.GDResumoObjects1.length ;i < len;++i) {
    gdjs.Eq_46_32AzulClaraCode.GDResumoObjects1[i].setWrapping(true);
}
}{for(var i = 0, len = gdjs.Eq_46_32AzulClaraCode.GDRsp_9595CertaObjects1.length ;i < len;++i) {
    ...
    gdjs.Eq_46_32AzulClaraCode.GDResumoObjects1[i].setWrappingWidth(565);
}
}{for(var i = 0, len = gdjs.Eq_46_32AzulClaraCode.GDRsp_9595CertaObjects1.length ;i < len;++i) {
...
gdjs.Eq_46_32AzulClaraCode.GDResumoObjects1.length = 0;
gdjs.Eq_46_32AzulClaraCode.GDResumoObjects2.length = 0;
...
gdjs.Eq_46_32AzulClaraCode.eventsList1(runtimeScene);
gdjs.Eq_46_32AzulClaraCode.GDRsp_9595CertaObjects1.length = 0;
gdjs.Eq_46_32AzulClaraCode.GDRsp_9595CertaObjects2.length = 0;
gdjs.Eq_46_32AzulClaraCode.GDResumoObjects1.length = 0;
gdjs.Eq_46_32AzulClaraCode.GDResumoObjects2.length = 0;
