...
gdjs.Eq_46_32VerdeClaraCode.GDResumoObjects1= [];
gdjs.Eq_46_32VerdeClaraCode.GDResumoObjects2= [];
...
gdjs.copyArray(runtimeScene.getObjects("Resumo"), gdjs.Eq_46_32VerdeClaraCode.GDResumoObjects1);
gdjs.copyArray(runtimeScene.getObjects("Team_Name"), gdjs.Eq_46_32VerdeClaraCode.GDTeam_9595NameObjects1);
{for(var i = 0, len = gdjs.Eq_46_32VerdeClaraCode.GDResumoObjects1.length ;i < len;++i) {
    gdjs.Eq_46_32VerdeClaraCode.GDResumoObjects1[i].getBehavior("Text").setText("Local: " + runtimeScene.getScene().getVariables().getFromIndex(0).getAsString() + " Score: " + runtimeScene.getScene().getVariables().getFromIndex(1).getAsString() + " Rsp: " + runtimeScene.getScene().getVariables().getFromIndex(2).getAsString() + " Erros:" + runtimeScene.getScene().getVariables().getFromIndex(3).getAsString());
}
...
{gdjs.evtTools.firebaseTools.database.updateField(runtimeScene.getGame().getVariables().getFromIndex(3).getAsString(), "ClueGM", (( gdjs.Eq_46_32VerdeClaraCode.GDPistaGMObjects1.length === 0 ) ? "" :gdjs.Eq_46_32VerdeClaraCode.GDPistaGMObjects1[0].getBehavior("Text").getText()), runtimeScene.getScene().getVariables().getFromIndex(7));
}}
...
gdjs.copyArray(runtimeScene.getObjects("Team_Name"), gdjs.Eq_46_32VerdeClaraCode.GDTeam_9595NameObjects1);
{for(var i = 0, len = gdjs.Eq_46_32VerdeClaraCode.GDResumoObjects1.length ;i < len;++i) {
    gdjs.Eq_46_32VerdeClaraCode.GDResumoObjects1[i].setWrapping(true);
}
}{for(var i = 0, len = gdjs.Eq_46_32VerdeClaraCode.GDRsp_9595CertaObjects1.length ;i < len;++i) {
    ...
    gdjs.Eq_46_32VerdeClaraCode.GDResumoObjects1[i].setWrappingWidth(565);
}
}{for(var i = 0, len = gdjs.Eq_46_32VerdeClaraCode.GDRsp_9595CertaObjects1.length ;i < len;++i) {
...
gdjs.Eq_46_32VerdeClaraCode.GDResumoObjects1.length = 0;
gdjs.Eq_46_32VerdeClaraCode.GDResumoObjects2.length = 0;
